...
comp_dat = apply_labels(comp,
                      ...
                      t1edu = c("Primary School" = 1,
                                "Secondary School" = 2,
                                "(Technical) Secondary School Diploma" = 3,
                                "University Degree" = 4,
                                "Doctorate Degree" = 5,
                                "Other" = 6),
                      t1emotions = "Strength of different negative emotions about the event (increasing)",
                      t1found = c("Yes, I was involved in founding the business." = 1,
                                  "No, I was not involved in founding the business." = 2),
                      t1gender = c("Male" = 1,
                                   "Female" = 2,
                                   "Non-binary identified" = 3),
